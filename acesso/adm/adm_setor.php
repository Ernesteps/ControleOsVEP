...
$setores = $ctrl->ConsultarSetorCTRL(); //Colocando em baixo cai mostrar o ultimo que foi cadastrado
?>
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- Post passa informação invisível // Get torna-se visível -->
            <form method="post" action="adm_setor.php">
              ...
              <button class="btn btn-success" name="btn_gravar" onclick="return InserirSetor()"> Gravar </button>
